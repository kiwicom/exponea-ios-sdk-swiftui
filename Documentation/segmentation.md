...
> Real-time segmentation works with both Project/{user.mkg} and Stream/{user.dh} integration modes. No additional configuration is needed when using Stream integration.
